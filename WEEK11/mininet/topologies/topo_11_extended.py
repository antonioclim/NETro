#!/usr/bin/env python3
"""
Topologie Mininet – Săptămâna 11 (extinsă)
2 clienţi (h1, h2) pentru a evidenţia ip_hash (sticky sessions).
...
class LBTopo2Clients(Topo):
    """
    Topologie extinsă pentru ip_hash: 2 clienți pentru sticky sessions
...
def run_test(net, kit_root: Path):
    ...
    info("\n[TEST] ip_hash: fiecare client ar trebui să primească consistent acelaşi backend.\n")
