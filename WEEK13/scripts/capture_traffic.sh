#!/bin/bash
# ============================================================================
# capture_traffic.sh - Wrapper pentru capturarea traficului de rețea
# ============================================================================
# Facilitează capturarea și analiza traficului pentru laboratorul S13:
# - tcpdump wrapper cu filtre predefinite
# - Capturare pentru protocoale specifice (MQTT, FTP, HTTP)
# - Export în multiple formate (pcap, text)
...
build_tcpdump_command() {
    ...
    # Snapshot length (capturăm tot pachetul)
    cmd="$cmd -s 0"
...
run_capture() {
    ...
    # Captură cu timeout dacă e specificată durată
...
analyze_capture() {
    ...
    # MQTT specific (dacă e traffic MQTT)
