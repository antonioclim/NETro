 ...
 * Săptămâna 12: Protocoale Email (SMTP, POP3, IMAP) + RPC
    ...
    styles: {
        ...
        paragraphStyles: [
            { id: "Title", name: "Title", basedOn: "Normal",
                run: { size: 52, bold: true, color: COLORS.primary, font: "Arial" },
    ...
    sections: [{
        ...
        headers: {
            default: new Header({ children: [
                new Paragraph({
                    ...
                    children: [
                        new TextRun({ text: "Curs 12 – Protocoale Email & RPC | ", size: 18, color: COLORS.muted }),
                        new TextRun({ text: "Rețele de Calculatoare", size: 18, color: COLORS.primary, bold: true })
                    ]
                })
            ]})
        },
            ...
            default: new Footer({ children: [
                new Paragraph({
                    ...
                    children: [
                        ...
                        new TextRun({ text: " din ", size: 18, color: COLORS.muted }),
                        new TextRun({ children: [PageNumber.TOTAL_PAGES], size: 18, color: COLORS.muted }),
                        new TextRun({ text: " | Revolvix&Hypotheticalandrei", size: 16, color: COLORS.muted })
                    ]
                })
            ]})
        },
        children: [
            ...
            new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 120 }, children: [
                new TextRun({ text: "Protocoale de Email: SMTP, POP3, IMAP", size: 36, bold: true, color: COLORS.secondary })
            ]}),
            new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 120 }, children: [
                new TextRun({ text: "Seminar: Apelul de metodă la distanță (RPC)", size: 28, color: COLORS.dark })
            ]}),
            new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 360 }, children: [
                new TextRun({ text: "Rețele de Calculatoare | An 3, Semestrul 2 | 2024-2025", size: 22, color: COLORS.muted })
            ]}),
            new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 240 }, children: [
                new TextRun({ text: "Academia de Studii Economice București", size: 20, italics: true, color: COLORS.muted }),
            ]}),
            new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 480 }, children: [
                new TextRun({ text: "Cibernetică, Statistică și Informatică Economică", size: 20, italics: true, color: COLORS.muted }),
            ]}),
            
            // Document info box
            new Paragraph({ spacing: { before: 240, after: 120 }, children: [
                new TextRun({ text: "Informații document", size: 24, bold: true, color: COLORS.primary })
            ]}),
            createInfoTable(),
            ...
            new Paragraph({ spacing: { after: 120 }, children: [
                new TextRun({ text: "(Actualizați cu Ctrl+A, apoi F9 după deschidere în Word)", size: 18, italics: true, color: COLORS.muted })
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun("Această săptămână reprezintă o sinteză aplicată a cunoștințelor acumulate despre protocoalele de nivel aplicație. Ne concentrăm pe două direcții complementare: sistemele de email (SMTP, POP3, IMAP) pentru comunicarea asincronă și mecanismele RPC pentru invocarea sincronă a procedurilor la distanță.")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("Arhitectura sistemelor de email: MUA, MTA, MDA și interacțiunile dintre ele")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun(" (metadate pentru client)")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("SMTP (RFC 5321) – protocolul de trimitere: comenzi, răspunsuri, coduri de stare")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("POP3 (RFC 1939) – descărcarea mesajelor cu model download-and-delete")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("IMAP (RFC 3501) – acces sincronizat multi-dispozitiv cu structură de foldere")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ children: [
                new TextRun("Email-ul rămâne infrastructura critică pentru comunicarea în mediul business, autentificarea utilizatorilor (password reset, 2FA prin email), notificările automate și integrările între sisteme. Înțelegerea protocoalelor subiacente permite debugging-ul problemelor de livrare, configurarea corectă a serverelor și implementarea de soluții custom.")
            ]}),
            new Paragraph({ spacing: { before: 120 }, children: [
                new TextRun("RPC reprezintă fundamentul arhitecturilor distribuite moderne: de la microservicii la sisteme cloud-native. JSON-RPC este omniprezent în API-urile blockchain și cryptocurrency, XML-RPC încă există în sisteme legacy, iar gRPC domină comunicarea inter-servicii în infrastructuri la scară largă (Google, Netflix, Uber).")
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun("Această săptămână pregătește studenții pentru:")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun("Alegerea între REST, gRPC, message queues pentru comunicarea inter-servicii")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun(" (S8): conexiuni persistente, garantarea livrării, flow control")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ style: "InstructorNote", spacing: { before: 180 }, children: [
                new TextRun({ text: "📝 Notă instructor: ", bold: true }),
                new TextRun("Alocați 5 minute la început pentru verificarea cunoștințelor. Întrebări rapide: Ce port folosește HTTPS? Ce înregistrare DNS indică serverul de mail? Ce diferență e între TCP și UDP?")
            ]}),
            ...
            new Paragraph({ heading: HeadingLevel.HEADING_2, children: [new TextRun("3.1 Arhitectura sistemelor de email")] }),
            new Paragraph({ children: [
                new TextRun("Un sistem de email implică mai multe componente care colaborează pentru a livra mesajele de la expeditor la destinatar. Această arhitectură stratificată permite flexibilitate și specializare:")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "steps-list", level: 0 }, children: [
                new TextRun("MUA trimite mesajul către MTA local prin SMTP (port 587 cu autentificare)")
            ]}),
            new Paragraph({ numbering: { reference: "steps-list", level: 0 }, children: [
                new TextRun("MTA local rezolvă înregistrarea MX pentru domeniul destinatar")
            ]}),
            new Paragraph({ numbering: { reference: "steps-list", level: 0 }, children: [
                new TextRun("MTA local trimite mesajul către MTA destinatar prin SMTP (port 25)")
            ]}),
            new Paragraph({ numbering: { reference: "steps-list", level: 0 }, children: [
                new TextRun("MTA destinatar predă mesajul către MDA pentru stocare")
            ]}),
            new Paragraph({ numbering: { reference: "steps-list", level: 0 }, children: [
            ...
            new Paragraph({ children: [
                ...
                new TextRun(" conține informațiile de rutare folosite de serverele SMTP, în timp ce "),
                new TextRun({ text: "message headers", bold: true }),
                new TextRun(" sunt metadate pentru clientul de email:")
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun("SMTP (RFC 5321) este un protocol text bazat pe comenzi și răspunsuri. Fiecare comandă primește un cod de răspuns de 3 cifre similar cu HTTP:")
            ]}),
            ...
            new Paragraph({ spacing: { before: 180 }, children: [
                new TextRun({ text: "Sesiune SMTP tipică:", bold: true })
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun("POP3 (RFC 1939) oferă acces simplu la mailbox cu model "),
                new TextRun({ text: "download-and-delete", italics: true }),
                new TextRun(". Este potrivit pentru un singur dispozitiv și conexiuni intermitente:")
            ]}),
            ...
            new Paragraph({ spacing: { before: 120 }, children: [
                ...
                new TextRun("Nu menține starea pe server (după descărcare, mesajele sunt șterse implicit), nu suportă foldere, nu sincronizează între dispozitive.")
            ]}),
            ...
            new Paragraph({ children: [
                ...
                new TextRun({ text: "sincronizare multi-dispozitiv", bold: true }),
            ...
            new Paragraph({ children: [
                new TextRun("MIME (Multipurpose Internet Mail Extensions) extinde formatul email pentru a suporta conținut non-ASCII, atașamente și mesaje multipart. Header-ul "),
                new TextRun({ text: "Content-Type", bold: true }),
                new TextRun(" specifică tipul conținutului:")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun({ text: "text/plain", bold: true }),
                new TextRun(" – text simplu fără formatare")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun(" – versiuni alternative (text + HTML)")
            ]}),
            ...
            new Paragraph({ style: "InstructorNote", spacing: { before: 180 }, children: [
                new TextRun({ text: "📝 Verificare cunoștințe:", bold: true }),
                new TextRun(" 1) Care e diferența între MAIL FROM și header-ul From:? 2) De ce IMAP e preferat pentru multi-device? 3) Ce verifică SPF?")
            ]}),
            ...
            new Paragraph({ spacing: { before: 180 }, children: [
                new TextRun({ text: "Componentele unui sistem RPC:", bold: true })
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun("TCP, HTTP, sau alt protocol pentru transmisia efectivă")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ children: [
                new TextRun("JSON-RPC este o specificație ușoară pentru RPC peste JSON. Este utilizat extensiv în API-urile blockchain (Bitcoin, Ethereum), servere LSP (Language Server Protocol) și diverse servicii web.")
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun("XML-RPC este predecesorul JSON-RPC, folosind XML pentru serializare. Deși mai verbose, oferă funcții de introspecție (listarea metodelor disponibile) și rămâne prezent în sisteme legacy.")
            ]}),
            
            new Paragraph({ style: "CodeBlock", spacing: { before: 120 }, children: [
                new TextRun('<?xml version="1.0"?>\n'),
            ...
            new Paragraph({ children: [
                new TextRun("gRPC (Google RPC) utilizează Protocol Buffers pentru serializare binară eficientă și HTTP/2 pentru transport. Oferă performanță superioară și suport nativ pentru streaming bidirecțional.")
            ]}),
            
            new Paragraph({ spacing: { before: 180 }, children: [
                new TextRun({ text: "Exemplu definiție .proto:", bold: true })
            ]}),
            new Paragraph({ style: "CodeBlock", children: [
            ...
            new Paragraph({ style: "InstructorNote", spacing: { before: 180 }, children: [
                ...
                new TextRun("Când alegeți JSON-RPC vs gRPC? JSON-RPC: simplicitate, debugging ușor, compatibilitate browser. gRPC: performanță, microservicii interne, când bandwidth e critic.")
            ]}),
            ...
            new Paragraph({ style: "CodeBlock", children: [
                ...
                new TextRun("├── scripts/          # Shell scripts pentru setup/capture\n"),
            ...
            new Paragraph({ style: "CodeBlock", children: [
                ...
                new TextRun("\n"),
                new TextRun("# 3. Verificați mediul\n"),
            ...
            new Paragraph({ spacing: { before: 120 }, children: [
                new TextRun({ text: "Pas 2: Trimiteți un email de test", bold: true })
            ]}),
            new Paragraph({ style: "CodeBlock", children: [
                ...
                new TextRun("    --body 'Mesaj de test pentru laborator'")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("tshark arată conversația completă inclusiv corpul mesajului")
            ]}),
            ...
            new Paragraph({ heading: HeadingLevel.HEADING_2, children: [new TextRun("5.4 Extensii opționale")] }),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun({ text: "Atașament MIME: ", bold: true }),
                new TextRun("Modificați smtp_client.py pentru a trimite un fișier atașat")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun({ text: "Batch JSON-RPC: ", bold: true }),
                new TextRun("Trimiteți 10 cereri într-un singur request și măsurați overhead-ul")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun({ text: "Mininet topology: ", bold: true }),
                new TextRun("Rulați scenariul email între host-uri separate în topologia simulată")
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun("Filtre utile pentru analiza traficului:")
            ]}),
            new Paragraph({ style: "CodeBlock", children: [
                new TextRun("# SMTP\n"),
            ...
            new Paragraph({ children: [
                new TextRun("Exercițiile sunt gradate progresiv. Primele trei sunt obligatorii, următoarele opționale pentru studenții avansați.")
            ]}),
            
            new Paragraph({ heading: HeadingLevel.HEADING_2, children: [new TextRun("Exercițiul 1: Analiză SMTP (★☆☆)")] }),
            new Paragraph({ children: [
                new TextRun({ text: "Obiectiv: ", bold: true }),
                new TextRun("Identificarea componentelor unei sesiuni SMTP")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Task: ", bold: true }),
                new TextRun("Capturați o sesiune SMTP și identificați: greeting banner, comenzile client, răspunsurile server, envelope vs headers.")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Livrabil: ", bold: true }),
                new TextRun("Screenshot Wireshark cu adnotări pentru fiecare componentă.")
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun({ text: "Task: ", bold: true }),
                new TextRun("Modificați smtp_client.py pentru a trimite către 3 destinatari diferiți. Observați câte comenzi RCPT TO sunt necesare.")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Livrabil: ", bold: true }),
            ...
            new Paragraph({ children: [
                new TextRun({ text: "Task: ", bold: true }),
                new TextRun("Scrieți un client Python care apelează toate metodele expuse de jsonrpc_server.py folosind doar biblioteca requests (fără json-rpc clients).")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Livrabil: ", bold: true }),
                new TextRun("Script Python funcțional + output pentru fiecare metodă.")
            ]}),
            ...
            new Paragraph({ children: [
                new TextRun({ text: "Task: ", bold: true }),
                new TextRun("Trimiteți cereri invalide către server (method inexistent, params greșite, JSON malformat) și documentați răspunsurile.")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Livrabil: ", bold: true }),
            ...
            new Paragraph({ children: [
                new TextRun({ text: "Task: ", bold: true }),
                new TextRun("Comparați timpul pentru 100 de apeluri individuale vs 10 batch-uri de câte 10 cereri. Calculați overhead-ul conexiunilor.")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Livrabil: ", bold: true }),
            ...
            new Paragraph({ children: [
                new TextRun({ text: "Task: ", bold: true }),
                new TextRun("Extindeți smtp_server.py pentru a redirecționa mesajele primite către un alt server SMTP (de ex: serverul colegului). Implementați logging pentru audit.")
            ]}),
            new Paragraph({ children: [
                new TextRun({ text: "Livrabil: ", bold: true }),
            ...
            new Paragraph({ numbering: { reference: "recap-list", level: 0 }, children: [
                new TextRun("Arhitectura sistemelor de email: MUA → MTA → MDA și protocoalele asociate")
            ]}),
            new Paragraph({ numbering: { reference: "recap-list", level: 0 }, children: [
                new TextRun("Diferența critică între envelope (rutare) și headers (metadate)")
            ]}),
            new Paragraph({ numbering: { reference: "recap-list", level: 0 }, children: [
                new TextRun("SMTP pentru trimitere, POP3 pentru download simplu, IMAP pentru acces sincronizat")
            ]}),
            new Paragraph({ numbering: { reference: "recap-list", level: 0 }, children: [
                new TextRun("Conceptul RPC și abstractizarea apelurilor de funcții peste rețea")
            ]}),
            new Paragraph({ numbering: { reference: "recap-list", level: 0 }, children: [
                new TextRun("Trade-off-uri între JSON-RPC (simplitate) și gRPC (performanță)")
            ]}),
            new Paragraph({ numbering: { reference: "recap-list", level: 0 }, children: [
                new TextRun("Mecanisme anti-spam: SPF, DKIM, DMARC")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun("Toate nodurile Bitcoin/Ethereum expun JSON-RPC pentru interacțiuni")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun({ text: "IDE extensions: ", bold: true }),
                new TextRun("Language Server Protocol folosește JSON-RPC pentru comunicare editor-server")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("Integrarea cu servicii de email pentru notificări în aplicații")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("Debugging-ul problemelor de deliverability ('de ce nu ajung email-urile?')")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("Alegerea protocolului potrivit pentru comunicarea inter-servicii")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ children: [
                new TextRun("Proiectul de echipă pentru Rețele de Calculatoare acumulează săptămânal artefacte care demonstrează competențele dobândite. Pentru Săptămâna 12:")
            ]}),
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("Implementați un modul care trimite notificări email pentru evenimente din proiect")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                new TextRun("Folosiți serverul SMTP educațional sau integrați cu un serviciu real (SendGrid tier gratuit)")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
                ...
                new TextRun(" – Post Office Protocol Version 3 (POP3)")
            ]}),
            new Paragraph({ numbering: { reference: "main-bullets", level: 0 }, children: [
            ...
            new Paragraph({ spacing: { before: 480 }, alignment: AlignmentType.CENTER, children: [
                new TextRun({ text: "— Document generat pentru uz didactic —", size: 18, italics: true, color: COLORS.muted })
            ]}),
        ...
        rows: [
            new TableRow({
                ...
                children: [
                    ...
                    createHeaderCell("Verificare rapidă")
                ]
            }),
            new TableRow({
                children: [
    ...
    return new Table({
        ...
        rows: [
            ...
            new TableRow({
                children: [
                    createBodyCell("MUA"),
                    createBodyCell("Mail User Agent – interfața utilizatorului"),
            ...
            new TableRow({
                children: [
                    createBodyCell("MSA"),
                    createBodyCell("Mail Submission Agent – primește de la MUA (port 587)"),
        ...
        rows: [
            ...
            new TableRow({
                children: [
                    ...
                    createBodyCell("Afișare – ce vede utilizatorul")
                ]
            }),
            new TableRow({
                children: [
            ...
            new TableRow({
                children: [
                    ...
                    createBodyCell("To: Visible Recipient <shown@email.com>")
                ]
            }),
            new TableRow({
                children: [
...
function createSmtpCommandsTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("EHLO"), createBodyCell("Identificare client, solicită extensions"), createBodyCell("250 (multi-line)")] }),
            ...
            new TableRow({ children: [createBodyCell("DATA"), createBodyCell("Începe transmisia corpului mesajului"), createBodyCell("354 Start input")] }),
            new TableRow({ children: [createBodyCell("QUIT"), createBodyCell("Închide conexiunea"), createBodyCell("221 Bye")] }),
            new TableRow({ children: [createBodyCell("RSET"), createBodyCell("Resetează sesiunea curentă"), createBodyCell("250 OK")] }),
...
function createPop3CommandsTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("STAT"), createBodyCell("Returnează numărul și dimensiunea mesajelor"), createBodyCell("+OK n size")] }),
            new TableRow({ children: [createBodyCell("LIST"), createBodyCell("Listează mesajele cu dimensiunile"), createBodyCell("+OK (multi-line)")] }),
            new TableRow({ children: [createBodyCell("RETR n"), createBodyCell("Descarcă mesajul n"), createBodyCell("+OK (content)")] }),
            new TableRow({ children: [createBodyCell("DELE n"), createBodyCell("Marchează mesajul n pentru ștergere"), createBodyCell("+OK deleted")] }),
...
function createImapVsPop3Table() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("Model"), createBodyCell("Download-and-delete"), createBodyCell("Server-side storage")] }),
            new TableRow({ children: [createBodyCell("Multi-dispozitiv"), createBodyCell("Nu – un singur client"), createBodyCell("Da – sincronizat")] }),
            new TableRow({ children: [createBodyCell("Foldere"), createBodyCell("Nu"), createBodyCell("Da – ierarhie completă")] }),
            new TableRow({ children: [createBodyCell("Search"), createBodyCell("Client-side"), createBodyCell("Server-side (SEARCH)")] }),
            ...
            new TableRow({ children: [createBodyCell("Offline"), createBodyCell("Da, după download"), createBodyCell("Necesită sincronizare")] }),
    ...
    return new Table({
        ...
        rows: [
            ...
            new TableRow({
                children: [
                    createBodyCell("SPF"),
                    createBodyCell("IP-ul expeditorului e autorizat pentru domeniu"),
...
function createJsonRpcErrorsTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("-32602"), createBodyCell("Invalid params"), createBodyCell("Parametri invalizi")] }),
...
function createRpcComparisonTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("Use case"), createBodyCell("APIs simple, blockchain"), createBodyCell("Legacy systems"), createBodyCell("Microservicii, real-time")] })
        ]
    });
}
...
function createSmtpErrorsTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("550 Relaying denied"), createBodyCell("Serverul nu acceptă mail pentru domeniul destinatar"), createBodyCell("Verificați că serverul e configurat ca relay sau folosiți un server autorizat")] }),
            new TableRow({ children: [createBodyCell("421 Too many connections"), createBodyCell("Rate limiting activ"), createBodyCell("Reduceți frecvența sau folosiți connection pooling")] }),
            new TableRow({ children: [createBodyCell("554 SPF check failed"), createBodyCell("IP-ul expeditorului nu e în lista SPF"), createBodyCell("Trimiteți de pe un server autorizat în înregistrarea SPF")] }),
            new TableRow({ children: [createBodyCell("Connection refused"), createBodyCell("Serverul nu ascultă pe portul specificat"), createBodyCell("Verificați portul (25, 587, 465) și firewall")] })
        ]
    });
}
...
function createRpcErrorsTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("Connection refused"), createBodyCell("Serverul RPC nu rulează"), createBodyCell("Verificați că procesul e activ pe portul corect")] }),
            new TableRow({ children: [createBodyCell("-32601 Method not found"), createBodyCell("Numele metodei e greșit"), createBodyCell("Verificați spelling-ul, case-sensitivity")] }),
...
function createProjectRubricTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [createBodyCell("Documentație"), createBodyCell("README clar, exemple de utilizare"), createBodyCell("0-2p"), createBodyCell("20%")] }),
...
function createBibliographyTable() {
    return new Table({
        ...
        rows: [
            ...
            new TableRow({ children: [
                createBodyCell("[3]"),
                createBodyCell("Crispin, M. (2003). Internet Message Access Protocol - Version 4rev1. IETF."),
